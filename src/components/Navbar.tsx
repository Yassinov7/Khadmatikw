...
export function Navbar() {
  ...
  const [activeDropdown, setActiveDropdown] = useState<"football" | "iptv" | "webDev" | "services" | null>(null);
  ...
  const toggleDropdown = (key: "football" | "iptv" | "webDev" | "services") => setActiveDropdown((current) => (current === key ? null : key));
  const toggleMobileSection = (key: string) => setExpandedMobile((current) => ({ ...current, [key]: !current[key] }));
