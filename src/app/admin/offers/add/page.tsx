...
export default function AddOfferPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (error) return setError("فشل في إضافة العرض!");
    setSuccess("تمت إضافة العرض بنجاح");
  ...
  return (
    <section className="max-w-lg mx-auto py-10 px-4 bg-background">
      <h2 className="text-xl font-bold text-primary mb-6 text-center">إضافة عرض جديد</h2>
